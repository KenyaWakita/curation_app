...
public class Constants {//static�̓R���X�^���X�����Ȃ��Ă��Q�Ƃł���
    ...
    static ArrayList<FetchYoutube> youtube_vs = new ArrayList<FetchYoutube>();
    static ArrayList<FetchYoutube> youtube_cardlist = new ArrayList<FetchYoutube>();
    static ArrayList<FetchYoutube> youtube_sing = new ArrayList<FetchYoutube>();
    static ArrayList<FetchYoutube> youtube_game = new ArrayList<FetchYoutube>();
    ...
    public static final String SEARCH_KEYWORD = "ムシキング%20対戦動画";
    public static final String CHANNEL_ID = "UCoObuRNP0OjE5ILcOAhXZIg";

    public static final String YOUTUBE_URL ="https://www.googleapis.com/youtube/v3/search?key=" + Constants.YOUTUBE_API_KEY + "&q=" + Constants.SEARCH_KEYWORD + "&part=snippet&maxResults=20&order=relevance";
